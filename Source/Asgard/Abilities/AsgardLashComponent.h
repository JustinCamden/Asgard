...
public:	
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AsgardLashComponent, meta = (ClampMin = "0.5", ClampMax = "1.0"))
	...
	* Ignored if <= 0.
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AsgardLashComponent, meta = (AllowPrivateAccess = "true"))
	...
	UFUNCTION(BlueprintCallable, Category = AsgardLashComponent)
...
private:
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AsgardLashComponent, meta = (AllowPrivateAccess = "true", ClampMin = "30.0"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = AsgardLashComponent, meta = (AllowPrivateAccess = "true", ClampMin = "0.0", ClampMax = "1.0"))
	...
	*/
	...
	UPROPERTY(BlueprintReadOnly, Category = "AsgardLashComponent|Collision", meta = (AllowPrivateAccess = "true"))
	bool bLashBlocked;
	...
	*/
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "AsgardLashComponent|Collision", meta = (AllowPrivateAccess = "true", ClampMin = "0.0"))
