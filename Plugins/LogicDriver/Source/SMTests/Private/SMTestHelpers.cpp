...
USMInstance* TestHelpers::RunStateMachineToCompletion(FAutomationTestBase* Test, USMBlueprint* Blueprint,
	int32& LogicEntryValueOut, int32& LogicUpdateValueOut, int32& LogicEndValueOut, int32 MaxIterations, bool bShutdownStateMachine, bool bTestCompletion, bool bCompile)
{
	if (bCompile)
	{
		FKismetEditorUtilities::CompileBlueprint(Blueprint);
